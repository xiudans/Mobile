...
function allClearLocalStorage(){
    ...
    allClear.addEventListener("click",
        function(e){
            e.preventDefault();
            let w_confirm = confirm("LocalStorageのデータ全て削除しますか？");
            if(w_confirm ===true){
                localStorage.clear();
                viewStorage();
                let w_msg = "LocalStorageのデータ全て削除しました";
                window.alert(w_msg);
                document.getElementById("textKey").value ="";
                document.getElementById("textMemo").value= "";
            }
...
function selectRadioBtn(){
    ...
    const radio2 = document.getElementById("table1");
